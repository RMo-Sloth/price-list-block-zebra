...
describe('BlockSettingsFunction', () => {
	...
	describe('.toggleSetting() ', () => {
		...
		test('toggles add', () => {
			const default_record =  BlockSettingsFunction.default();
			const toggled_once = BlockSettingsFunction.toggleSetting( default_record, 'add' );
			const toggled_twice = BlockSettingsFunction.toggleSetting( toggled_once, 'add' );
		...
		test('toggles delete', () => {
			const default_record =  BlockSettingsFunction.default();
			const toggled_once = BlockSettingsFunction.toggleSetting( default_record, 'delete' );
			const toggled_twice = BlockSettingsFunction.toggleSetting( toggled_once, 'delete' );
		...
		test('returns an immutable object', () => {
			const default_record = BlockSettingsFunction.default();
			const updated_record = BlockSettingsFunction.toggleSetting( default_record, 'delete' )
