...
function UpdatePriceRecord(props) {
	...
	function set_initial_focus() {
		if (props.focus === false) set_focus(null);
		else if (props.settings.order_items === true) set_focus('order_button');
		else if (props.settings.edit_description === true)
			set_focus('description_input');
		else if (props.settings.edit_price === true) set_focus('price_input');
		else if (props.settings.delete === true) set_focus('delete_button');
	}
