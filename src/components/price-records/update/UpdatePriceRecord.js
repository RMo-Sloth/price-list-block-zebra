...
function UpdatePriceRecord( props ) {
    ...
    return (<div className={css['update-price-record']} > 
        <OrderButton display={props.settings.order_items } record={props.record} move_up={move_up} enable_move_up={props.index > 0} enable_move_down={props.total_records > props.index + 1} focus={ focus === 'order_button' } />
