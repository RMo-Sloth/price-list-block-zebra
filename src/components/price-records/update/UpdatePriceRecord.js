...
function UpdatePriceRecord( props ) {
    ...
    return (<div className={css['update-price-record']} > 
        <OrderButton display={props.settings.order_items } record={props.record} enable_move_up={props.index > 0} enable_move_down={records.records.length > props.index + 1} focus={ focus === 'order_button' } />
